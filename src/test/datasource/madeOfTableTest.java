...
//
//            ArrayList<madeOfDTO> madeOfArray = madeOfTable.findAll();
//
...
//        try {
//            madeOfDTO compoundID = madeOfTable.findByCompoundID(4);
//
...
//        try {
//            madeOfDTO compoundID = madeOfTable.findByElementID(25);
//
//            assertNotNull(compoundID);
...
//
//            madeOfDTO elementID = madeOfTable.findByElementID(16);
//            madeOfDTO compoundID = madeOfTable.findByCompoundID(1);
//
